...
function CurrentStageContent() {
  ...
  if (isChecking || !stageNumber) {
    return <main className="min-h-screen bg-slate-100 px-4 py-6 text-slate-900">Loading current stage…</main>;
  }
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
          <div className="mb-5 flex items-center justify-between gap-3">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.15em] text-slate-500">Team</p>
